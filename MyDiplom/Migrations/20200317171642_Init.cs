        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceOnStand = table.Column<int>(nullable: false),
                    typeDevice = table.Column<string>(nullable: true),
                    NumberDevice = table.Column<long>(nullable: false),
                    YearDevice = table.Column<int>(nullable: false),
                    DateCheck = table.Column<DateTime>(nullable: false),
                    DateFutureCheck = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FailureId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DateFailure = table.Column<DateTime>(nullable: false),
